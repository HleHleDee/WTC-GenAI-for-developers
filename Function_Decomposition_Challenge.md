...
**Prompt used**
I have a large validation function and I want to understand it better.

Please:
1. Break down what this function is doing into logical responsibilities
2. Identify different sections of logic
3. Explain which parts might be doing too many things
...
The AI identified that the function has multiple responsibilities:

Required field validation (registration vs profile)
...
Address validation (nested object + country rules)
Phone validation
Custom validations

 AI pointed out:

The function violates Single Responsibility Principle
Too many nested conditionals → hard to maintain


# Creating a Decomposition Plan

**Prompt Used**
Based on the responsibilities identified:

1. Suggest a decomposition plan
2. List helper functions I should create
3. Explain what each function should do
4. Keep explanations simple (I am still learning)

Do NOT rewrite the full code yet.
...
Let’s start refactoring step by step.

Help me extract the required fields validation into its own function.

1. Show me the extracted function
2. Explain what changed
3. Explain how I can test this safely

**Response (Summary)**

Extracted logic for required fields into:
validateRequiredFields(userData, isRegistration)


Improvement:

Removed nested loop from main function
...
Test missing fields
Test empty values
Test registration vs profile cases
...
Continue helping me refactor the remaining parts into helper functions.
...
Each validation was separated:

Function	Responsibility
validateUsername	username rules + uniqueness
validatePassword	strength + confirmation
validateEmail	format + duplicate check
validateDateOfBirth	age + date validation
validateAddress	nested object validation
validatePhone	phone format
applyCustomValidations	dynamic rules


# Final Refactored Structure

**Prompt Used**
Now show me how the main function should look after refactoring,
using all helper functions.

**Response (Final Structure)**

function validateUserData(userData, options = {}) {
  const errors = [];

  errors.push(...validateRequiredFields(userData, options.isRegistration));
...
How did decomposition improve readability?

It reduced complexity by breaking one large function into smaller, understandable pieces.

What was the most challenging part?

Making sure no validation logic was lost while splitting the code.
...
The function was doing too many things
Some logic was duplicated
Clear separation of concerns was missing

How would you approach similar problems in future?
